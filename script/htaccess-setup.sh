...
then
	...
	echo 'RewriteRule ^\/?background\.png$ /file.cgi?file=Bob85Bob85Logo.png [L]' >> www/.htaccess
	echo 'RewriteRule ^\/?logo\.png$ /file.cgi?file=Bob85Logo.png [L]' >> www/.htaccess
	...
	echo >> www/.htaccess
	echo 'RewriteCond %{DOCUMENT_ROOT}/local.Bob85Bob85Logo.png -f' >> www/.htaccess
	echo 'RewriteRule ^\/?background\.png$ /local.Bob85Bob85Logo.png [L]' >> www/.htaccess
	echo >> www/.htaccess
	echo 'RewriteCond %{DOCUMENT_ROOT}/local.Bob85Logo.png -f' >> www/.htaccess
	echo 'RewriteRule ^\/?logo\.png$ /local.Bob85Logo.png [L]' >> www/.htaccess
	echo >> www/.htaccess
