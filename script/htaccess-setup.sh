...
then
	...
	echo 'RewriteRule ^\/?background\.png$ /file.cgi?file=bobground.png [L]' >> www/.htaccess
	...
	echo >> www/.htaccess
	echo 'RewriteCond %{DOCUMENT_ROOT}/local.bobground.png -f' >> www/.htaccess
	echo 'RewriteRule ^\/?background\.png$ /local.bobground.png [L]' >> www/.htaccess
	echo >> www/.htaccess
